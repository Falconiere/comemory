...
- handle stale v2-stamped auth credentials ([#299](https://github.com/Falconiere/comemory/pull/299))
...
- replicate feedback and activity as events counted once ([#293](https://github.com/Falconiere/comemory/pull/293))
...
- capture every memory mutation and recover an interrupted write ([#274](https://github.com/Falconiere/comemory/pull/274))
...
- add the real-process replication harness ([#259](https://github.com/Falconiere/comemory/pull/259))

## [0.43.1] - 2026-09-21

### Fixed

- reserve the writer before the index-code walk ([#246](https://github.com/Falconiere/comemory/pull/246))
...
- expose architecture model tools ([#241](https://github.com/Falconiere/comemory/pull/241))

## [0.42.0] - 2026-09-20

### Added

- enforce repository policy ([#237](https://github.com/Falconiere/comemory/pull/237))
...
- remove external reranking, keep the retrieval-quality instrumentation ([#231](https://github.com/Falconiere/comemory/pull/231))
...
- build supported runtime queries with toolu-orm ([#216](https://github.com/Falconiere/comemory/pull/216))

## [0.35.1] - 2026-09-18

### Fixed

- paged search is non-deterministic on tied scores ([#203](https://github.com/Falconiere/comemory/pull/203))
...
- add the comemory setup onboarding command ([#163](https://github.com/Falconiere/comemory/pull/163))

### Fixed

- stop stale reindex hooks from registering every worktree as a repo ([#162](https://github.com/Falconiere/comemory/pull/162))

## [0.32.4] - 2026-09-16

### Fixed

- optimize graph and listing queries ([#160](https://github.com/Falconiere/comemory/pull/160))

## [0.32.3] - 2026-09-16

### Added

- serve indexed source and make AGENTS.md canonical ([#158](https://github.com/Falconiere/comemory/pull/158))
...
- file every linked worktree under its main repo's label ([#151](https://github.com/Falconiere/comemory/pull/151))
...
- sync every memory, push inline, and follow changes live ([#146](https://github.com/Falconiere/comemory/pull/146))
...
- enable reqwest rustls for https platforms ([#139](https://github.com/Falconiere/comemory/pull/139))

## [0.28.1] - 2026-09-12

### Added

- declare the schema with toolu-orm and move migrations to migrations/ ([#136](https://github.com/Falconiere/comemory/pull/136))

## [0.28.0] - 2026-09-12

### Added

- store caller-supplied feedback provenance ([#133](https://github.com/Falconiere/comemory/pull/133))
...
- client session capture for Slice 3 ([#127](https://github.com/Falconiere/comemory/pull/127))
...
- scope the cloud key to an organization and sync at login

### Fixed

- report the save before waiting on its push; cover off_runtime

## [0.23.0] - 2026-09-10

### Fixed

- mint a device key on `comemory auth login`

## [0.22.1] - 2026-09-10

### Fixed

- repair a clock-derived flake; refactor(store): extract chokepoint duplication ([#116](https://github.com/Falconiere/comemory/pull/116))
...
- publish a multi-arch container image to GHCR on every tag

### Fixed

- drop the unreachable leg-count guard in the manifest job
- address PR review feedback on the container image
...
- mint release-plz tokens from the publish App ([#69](https://github.com/Falconiere/comemory/pull/69))

## [0.14.2] - 2026-08-06

### Internal

- read the tap App credentials from HOMEBREW_APP_* secrets ([#67](https://github.com/Falconiere/comemory/pull/67))

## [0.14.1] - 2026-08-03

### Fixed

- make days_since phase-independent ([#62](https://github.com/Falconiere/comemory/pull/62))

## [0.14.0] - 2026-08-02

### Added

- lexical document domain — registry, extraction, unified search (increment 1) ([#59](https://github.com/Falconiere/comemory/pull/59))

## [0.13.2] - 2026-08-01

### Internal

- upgrade code-review action v3 -> v6

## [0.13.1] - 2026-08-01

### Internal

- restore Linux build targets
...
- drop HOMEBREW_TAP_TOKEN, document GitHub App tap auth
- mint homebrew-tap token via GitHub App instead of PAT
...
- deterministically disable tracking in pagination-stability test
