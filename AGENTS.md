...
- **D4 — `src.nested` replaces the starter map** with the exact, project-specific
  ...
  project ownership.
- **D5 — `src.requireReadme` replaces the pinned single-`domains` rule during staging with exactly 42 folders.**
