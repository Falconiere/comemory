...
- **D4 — `src.nested` replaces the starter map** with the exact, project-specific
  ...
  - `domains/*`: `ast`, `cloud`, `document`, `exchange`, `index_code`, `memory_store`, `repos`, `source`, `unified`, `tests`, `proptest-regressions`
