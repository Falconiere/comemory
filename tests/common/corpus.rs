...
//!
//! Data only — the golden-pair builder lives in the sibling
//! `corpus_golden.rs` so binaries that just need the corpus rows (e.g. the
//! baseline ranking snapshot in `tests/retrieval__pipeline_2.rs`) exercise
