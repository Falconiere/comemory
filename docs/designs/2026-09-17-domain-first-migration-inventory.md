...
| src/cli/output/architecture.rs | comemory::cli::output::architecture; preserve | none | none | delivery::cli | src/cli/output/architecture.rs | retain |
...
| src/config/activity.rs | comemory::config::activity; preserve | src/config/tests/activity.rs | none | shared::config | src/config/activity.rs | retain |
...
| src/config/sections.rs | comemory::config::sections; preserve | none | none | shared::config | src/config/sections.rs | retain |
...
| src/config/validate_knobs.rs | private | none | none | shared::config | src/config/validate_knobs.rs | retain |
| src/domains.rs | comemory::domains; preserve | none | none | shared::root | src/domains.rs | retain |
| src/domains/architecture.rs | comemory::domains::architecture; preserve | none | none | domains::architecture | src/domains/architecture.rs | retain |
| src/domains/architecture/check.rs | comemory::domains::architecture::check; preserve | none | none | domains::architecture | src/domains/architecture/check.rs | retain |
| src/domains/architecture/cluster.rs | comemory::domains::architecture::cluster; preserve | src/domains/architecture/tests/cluster.rs | none | domains::architecture | src/domains/architecture/cluster.rs | retain |
| src/domains/architecture/current.rs | comemory::domains::architecture::current; preserve | src/domains/architecture/tests/current.rs | none | domains::architecture | src/domains/architecture/current.rs | retain |
| src/domains/architecture/extract.rs | comemory::domains::architecture::extract; preserve | src/domains/architecture/tests/extract.rs | none | domains::architecture | src/domains/architecture/extract.rs | retain |
| src/domains/architecture/learn.rs | comemory::domains::architecture::learn; preserve | none | none | domains::architecture | src/domains/architecture/learn.rs | retain |
| src/domains/architecture/mermaid.rs | comemory::domains::architecture::mermaid; preserve | src/domains/architecture/tests/mermaid.rs | none | domains::architecture | src/domains/architecture/mermaid.rs | retain |
| src/domains/architecture/model.rs | comemory::domains::architecture::model; preserve | none | none | domains::architecture | src/domains/architecture/model.rs | retain |
| src/domains/architecture/prompt.rs | comemory::domains::architecture::prompt; preserve | none | none | domains::architecture | src/domains/architecture/prompt.rs | retain |
| src/domains/architecture/save.rs | comemory::domains::architecture::save; preserve | none | none | domains::architecture | src/domains/architecture/save.rs | retain |
| src/domains/architecture/scaffold.rs | comemory::domains::architecture::scaffold; preserve | none | none | domains::architecture | src/domains/architecture/scaffold.rs | retain |
| src/domains/architecture/validate.rs | comemory::domains::architecture::validate; preserve | src/domains/architecture/tests/validate.rs | none | domains::architecture | src/domains/architecture/validate.rs | retain |
...
| src/domains/code/remote_view.rs | comemory::domains::code::remote_view; preserve | src/domains/code/tests/remote_view.rs | none | domains::code | src/domains/code/remote_view.rs | retain |
...
| src/domains/code/replica_payload.rs | comemory::domains::code::replica_payload; preserve | src/domains/code/tests/replica_payload.rs | none | domains::code | src/domains/code/replica_payload.rs | retain |
...
| src/domains/documents/document/deletions.rs | comemory::domains::documents::document::deletions; preserve | none | none | domains::documents | src/domains/documents/document/deletions.rs | retain |
...
| src/domains/documents/unindex.rs | comemory::domains::documents::unindex; breaking 0.34.0 docs/designs/2026-09-17-domain-first-migration-inventory.md#rust-module-path-release-note-for-0340 | src/domains/documents/tests/unindex.rs | none | domains::documents | src/domains/documents/unindex.rs | retain |
...
| src/domains/learning/feedback.rs | comemory::domains::learning::feedback; breaking 0.34.0 docs/designs/2026-09-17-domain-first-migration-inventory.md#rust-module-path-release-note-for-0340 | src/domains/learning/tests/activity.rs; src/domains/learning/tests/feedback.rs | none | domains::learning | src/domains/learning/feedback.rs | retain |
...
| src/domains/learning/feedback_share.rs | comemory::domains::learning::feedback_share; preserve | src/domains/learning/tests/feedback_share.rs | none | domains::learning | src/domains/learning/feedback_share.rs | retain |
...
| src/domains/learning/replica_payload.rs | comemory::domains::learning::replica_payload; preserve | src/domains/learning/tests/replica_payload.rs | none | domains::learning | src/domains/learning/replica_payload.rs | retain |
...
| src/domains/maintenance/activity.rs | comemory::domains::maintenance::activity; preserve | src/domains/maintenance/tests/activity.rs | none | domains::maintenance | src/domains/maintenance/activity.rs | retain |
...
| src/domains/memories/journal.rs | comemory::domains::memories::journal; preserve | src/domains/memories/tests/journal.rs | none | domains::memories | src/domains/memories/journal.rs | retain |
...
| src/domains/memories/recover.rs | comemory::domains::memories::recover; preserve | src/domains/memories/tests/recover.rs | none | domains::memories | src/domains/memories/recover.rs | retain |
| src/domains/memories/replica_payload.rs | comemory::domains::memories::replica_payload; preserve | src/domains/memories/tests/replica_payload.rs | none | domains::memories | src/domains/memories/replica_payload.rs | retain |
...
| src/domains/memories/save.rs | comemory::domains::memories::save; breaking 0.34.0 docs/designs/2026-09-17-domain-first-migration-inventory.md#rust-module-path-release-note-for-0340 | src/domains/memories/tests/activity.rs; src/domains/memories/tests/save.rs | none | domains::memories | src/domains/memories/save.rs | retain |
| src/domains/memories/save_activity.rs | comemory::domains::memories::save_activity; preserve | none | none | domains::memories | src/domains/memories/save_activity.rs | retain |
| src/domains/memories/save_persist.rs | comemory::domains::memories::save_persist; preserve | none | none | domains::memories | src/domains/memories/save_persist.rs | retain |
...
| src/domains/retrieval/search.rs | comemory::domains::retrieval::search; breaking 0.34.0 docs/designs/2026-09-17-domain-first-migration-inventory.md#rust-module-path-release-note-for-0340 | src/domains/retrieval/tests/activity.rs | none | domains::retrieval | src/domains/retrieval/search.rs | retain |
...
| src/domains/sync/replica/activity_payload.rs | comemory::domains::sync::replica::activity_payload; preserve | src/domains/sync/replica/tests/activity_payload.rs | none | domains::sync | src/domains/sync/replica/activity_payload.rs | retain |
...
| src/domains/sync/replica/document_accept.rs | comemory::domains::sync::replica::document_accept; preserve | src/domains/sync/replica/tests/document_accept.rs | none | domains::sync | src/domains/sync/replica/document_accept.rs | retain |
| src/domains/sync/replica/event_accept.rs | comemory::domains::sync::replica::event_accept; preserve | src/domains/sync/replica/tests/event_accept.rs | none | domains::sync | src/domains/sync/replica/event_accept.rs | retain |
...
| src/domains/sync/replica/event_capture.rs | comemory::domains::sync::replica::event_capture; preserve | src/domains/sync/replica/tests/event_capture.rs | none | domains::sync | src/domains/sync/replica/event_capture.rs | retain |
| src/domains/sync/replica/manifest.rs | comemory::domains::sync::replica::manifest; preserve | src/domains/sync/replica/tests/manifest.rs | none | domains::sync | src/domains/sync/replica/manifest.rs | retain |
| src/domains/sync/replica/materialize.rs | comemory::domains::sync::replica::materialize; preserve | src/domains/sync/replica/tests/materialize.rs | none | domains::sync | src/domains/sync/replica/materialize.rs | retain |
| src/domains/sync/replica/staging.rs | comemory::domains::sync::replica::staging; preserve | src/domains/sync/replica/tests/staging.rs | none | domains::sync | src/domains/sync/replica/staging.rs | retain |
| src/domains/sync/replica/validate.rs | comemory::domains::sync::replica::validate; preserve | src/domains/sync/replica/tests/validate.rs | none | domains::sync | src/domains/sync/replica/validate.rs | retain |
| src/domains/sync/replica/validate_events.rs | comemory::domains::sync::replica::validate_events; preserve | src/domains/sync/replica/tests/validate_events.rs | none | domains::sync | src/domains/sync/replica/validate_events.rs | retain |
| src/domains/sync/replica/pulled.rs | comemory::domains::sync::replica::pulled; preserve | src/domains/sync/replica/tests/pulled.rs | none | domains::sync | src/domains/sync/replica/pulled.rs | retain |
...
| src/domains/sync/drain.rs | comemory::domains::sync::drain; preserve | src/domains/sync/drain/tests/drain.rs; src/domains/sync/drain/tests/support.rs | none | domains::sync | src/domains/sync/drain.rs | retain |
| src/domains/sync/drain/backoff.rs | comemory::domains::sync::drain::backoff; preserve | src/domains/sync/drain/tests/backoff.rs | none | domains::sync | src/domains/sync/drain/backoff.rs | retain |
| src/domains/sync/drain/keying.rs | comemory::domains::sync::drain::keying; preserve | src/domains/sync/drain/tests/keying.rs | none | domains::sync | src/domains/sync/drain/keying.rs | retain |
| src/domains/sync/drain/negotiate.rs | comemory::domains::sync::drain::negotiate; preserve | src/domains/sync/drain/tests/negotiate.rs | none | domains::sync | src/domains/sync/drain/negotiate.rs | retain |
| src/domains/sync/drain/network.rs | comemory::domains::sync::drain::network; preserve | src/domains/sync/drain/tests/network.rs | none | domains::sync | src/domains/sync/drain/network.rs | retain |
| src/domains/sync/drain/retry_after.rs | comemory::domains::sync::drain::retry_after; preserve | src/domains/sync/drain/tests/retry_after.rs | none | domains::sync | src/domains/sync/drain/retry_after.rs | retain |
| src/domains/sync/drain/session.rs | comemory::domains::sync::drain::session; preserve | src/domains/sync/drain/tests/session.rs | none | domains::sync | src/domains/sync/drain/session.rs | retain |
| src/domains/sync/drain/transport.rs | comemory::domains::sync::drain::transport; preserve | src/domains/sync/drain/tests/transport.rs | none | domains::sync | src/domains/sync/drain/transport.rs | retain |
| src/domains/sync/drain/upgrade.rs | comemory::domains::sync::drain::upgrade; preserve | src/domains/sync/drain/tests/upgrade.rs | none | domains::sync | src/domains/sync/drain/upgrade.rs | retain |
| src/domains/sync/drain/anchor.rs | comemory::domains::sync::drain::anchor; preserve | src/domains/sync/drain/tests/anchor.rs | none | domains::sync | src/domains/sync/drain/anchor.rs | retain |
| src/domains/sync/drain/code_capture.rs | comemory::domains::sync::drain::code_capture; preserve | src/domains/sync/drain/tests/code_capture.rs | none | domains::sync | src/domains/sync/drain/code_capture.rs | retain |
| src/domains/sync/drain/holds.rs | comemory::domains::sync::drain::holds; preserve | src/domains/sync/drain/tests/holds.rs | none | domains::sync | src/domains/sync/drain/holds.rs | retain |
| src/domains/sync/drain/legacy_pass.rs | comemory::domains::sync::drain::legacy_pass; preserve | none | none | domains::sync | src/domains/sync/drain/legacy_pass.rs | retain |
| src/domains/sync/drain/pull_rules.rs | comemory::domains::sync::drain::pull_rules; preserve | src/domains/sync/drain/tests/pull_rules.rs | none | domains::sync | src/domains/sync/drain/pull_rules.rs | retain |
| src/domains/sync/drain/pull.rs | comemory::domains::sync::drain::pull; preserve | src/domains/sync/drain/tests/pull.rs | none | domains::sync | src/domains/sync/drain/pull.rs | retain |
| src/domains/sync/drain/push_batch.rs | comemory::domains::sync::drain::push_batch; preserve | src/domains/sync/drain/tests/push_batch.rs | none | domains::sync | src/domains/sync/drain/push_batch.rs | retain |
| src/domains/sync/drain/push_hold.rs | comemory::domains::sync::drain::push_hold; preserve | src/domains/sync/drain/tests/push_hold.rs | none | domains::sync | src/domains/sync/drain/push_hold.rs | retain |
| src/domains/sync/drain/push.rs | comemory::domains::sync::drain::push; preserve | src/domains/sync/drain/tests/push.rs | none | domains::sync | src/domains/sync/drain/push.rs | retain |
...
| src/serve/routes/activity.rs | comemory::serve::routes::activity; preserve | none | none | delivery::serve | src/serve/routes/activity.rs | retain |
| src/serve/routes/activity_stream.rs | comemory::serve::routes::activity_stream; preserve | none | none | delivery::serve | src/serve/routes/activity_stream.rs | retain |
...
| src/serve/routes/search_body.rs | comemory::serve::routes::search_body; preserve | none | none | delivery::serve | src/serve/routes/search_body.rs | retain |
...
| src/serve/routes/sync_replica.rs | comemory::serve::routes::sync_replica; preserve | src/serve/routes/tests/sync_replica.rs | none | delivery::serve | src/serve/routes/sync_replica.rs | retain |
...
| src/store/activity.rs | comemory::store::activity; preserve | src/store/tests/activity.rs | none | infrastructure::store | src/store/activity.rs | retain |
| src/store/activity_share.rs | comemory::store::activity_share; preserve | src/store/tests/activity_share.rs | none | infrastructure::store | src/store/activity_share.rs | retain |
| src/store/activity_rollups.rs | comemory::store::activity_rollups; preserve | src/store/tests/activity_rollups.rs | none | infrastructure::store | src/store/activity_rollups.rs | retain |
...
| src/store/migrate/historical_document_revision.rs | private | none | none | infrastructure::store | src/store/migrate/historical_document_revision.rs | retain |
...
| src/store/rebuild_copy_history.rs | comemory::store::rebuild_copy_history; preserve | src/store/tests/rebuild_copy_history.rs | none | infrastructure::store | src/store/rebuild_copy_history.rs | retain |
...
| src/store/repository_approval.rs | comemory::store::repository_approval; preserve | src/store/tests/repository_approval.rs | none | infrastructure::store | src/store/repository_approval.rs | retain |
...
| src/store/schema_code_generation.rs | comemory::store::schema_code_generation; preserve | none | none | infrastructure::store | src/store/schema_code_generation.rs | retain |
...
| src/store/schema_document_revision.rs | comemory::store::schema_document_revision; preserve | none | none | infrastructure::store | src/store/schema_document_revision.rs | retain |
...
| src/store/seed_scan.rs | comemory::store::seed_scan; preserve | src/store/tests/seed_scan.rs | none | infrastructure::store | src/store/seed_scan.rs | retain |
| src/store/schema_replica.rs | comemory::store::schema_replica; preserve | none | none | infrastructure::store | src/store/schema_replica.rs | retain |
| src/store/schema_replica_device.rs | comemory::store::schema_replica_device; preserve | none | none | infrastructure::store | src/store/schema_replica_device.rs | retain |
...
| src/store/schema_exchange.rs | comemory::store::schema_exchange; preserve | src/store/tests/schema_exchange.rs | none | infrastructure::store | src/store/schema_exchange.rs | retain |
| src/store/sync_exchange.rs | comemory::store::sync_exchange; preserve | src/store/tests/sync_exchange.rs | none | infrastructure::store | src/store/sync_exchange.rs | retain |
| src/store/sync_policy_snapshot.rs | comemory::store::sync_policy_snapshot; preserve | src/store/tests/sync_policy_snapshot.rs | none | infrastructure::store | src/store/sync_policy_snapshot.rs | retain |
| src/store/replica_pull_hold.rs | comemory::store::replica_pull_hold; preserve | src/store/tests/replica_pull_hold.rs | none | infrastructure::store | src/store/replica_pull_hold.rs | retain |
| src/store/replica_binding.rs | comemory::store::replica_binding; preserve | src/store/tests/replica_binding.rs | none | infrastructure::store | src/store/replica_binding.rs | retain |
...
| src/utilities/activity.rs | comemory::utilities::activity; preserve | src/utilities/tests/activity.rs | none | shared::utilities | src/utilities/activity.rs | retain |
...
| src/utilities/repo_label.rs | comemory::utilities::repo_label; preserve | src/utilities/tests/repo_label.rs | none | shared::utilities | src/utilities/repo_label.rs | retain |
