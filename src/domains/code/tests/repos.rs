...
//! Mirror test for `src/domains/code/repos.rs` (+ `repos/git_state.rs`). Real git
//! repos indexed through `crate::domains::code::index_code::run`, real memory rows, real
...
//! `tests/cli__repos.rs`; this file exercises `crate::domains::code::repos::run`'s SQL join
