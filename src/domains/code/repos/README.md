...
**What belongs here:** the git half of `domains::code::repos` — HEAD
comparison
...
`mod.rs` barrel — submodules are declared from `src/domains/code/repos.rs`
