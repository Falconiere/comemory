...
//! Test mirror for `src/domains/code/ast/languages.rs` — extension-based language
//! detection and the supported-language set.

use comemory::domains::code::ast::Lang;
use comemory::domains::code::ast::languages::{detect, supported};
use std::path::Path;
