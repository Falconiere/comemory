...
//! Test mirror for `src/domains/code/ast/chunk.rs` — cAST-style greedy chunking of
//! oversized AST nodes.
//!
...
use comemory::domains::code::ast::chunk::{CHUNK_LINE_BUDGET, Chunk, MIN_CHUNK_LINES, pack_spans};
...
fn small_symbol_yields_no_chunks() {
    let src = include_str!(concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/tests/ast/fixtures/small_fn.rs"
    ));
