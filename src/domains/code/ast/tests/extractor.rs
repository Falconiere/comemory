...
//! Test mirror for `src/domains/code/ast/extractor.rs` — symbol enumeration via
//! ast-grep across the supported languages.

use comemory::domains::code::ast::{ExtractedSymbol, Lang, extract};
