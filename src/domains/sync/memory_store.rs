//! `domains::sync::memory_store` — the one memory store's view and the
//! `store-sync` job (console-api spec §10, Non-Goal 3: "No multi-root memory
//! stores. One `data_dir` remains the model").
//!
