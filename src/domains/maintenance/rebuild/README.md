# domains/maintenance/rebuild/

**What belongs here:** the internals of `maintenance::rebuild` that do not fit
...
`src/domains/maintenance/rebuild.rs` (`pub mod <name>;`) and callers import
concrete paths.
