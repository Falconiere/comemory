//! `maintenance::consolidate::{Request, run}` — the shared middle of `comemory
...
//! `crate::domains::maintenance::consolidation`'s module doc.

use serde::Deserialize;

use crate::domains::maintenance::consolidation::{self, Options};
