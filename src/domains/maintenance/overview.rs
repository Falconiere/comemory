//! `maintenance::overview` — the console's landing aggregate (`GET /api/v1/overview`,
...
//! [`crate::domains::maintenance::stats::run`] for the counters, [`crate::domains::code::repos::run`]
...
//! link to.
//!
//! **Must-not-create-the-db invariant** (the same rule `maintenance::stats` and
...
use crate::domains::maintenance::stats;
