# domains/maintenance/consolidation/
...
`src/domains/maintenance/consolidation.rs` (`pub mod <name>;`) and callers
import concrete paths. The owned `Report` is a sibling of this folder at
`../consolidation_report.rs`, because both delivery surfaces and the command
core share it.
