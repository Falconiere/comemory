...
//! [`crate::domains::retrieval::code_prior`] (PageRank, ACT-R activation,
//! working-set affinity, Beta feedback), then chunk→parent coalescing.
//! Mirrors [`crate::domains::retrieval::rerank`] (the memory side): the same
...
//! [`crate::domains::retrieval::code_route`] and emits [`CodeReranked`] entries
...
use crate::domains::retrieval::code_prior::{self, Signals};
use crate::domains::retrieval::code_route::CodeRoutedHit;
use crate::domains::retrieval::router::Source;
use crate::domains::retrieval::score::{self, LegScores};
use crate::prelude::*;
