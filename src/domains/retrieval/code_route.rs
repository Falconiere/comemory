...
//! Mirrors [`crate::domains::retrieval::router`] (the memory side); there is no
...
use crate::domains::retrieval::fuse::{self, RankedHit};
use crate::domains::retrieval::router::{Source, above_similarity_threshold};
use crate::domains::retrieval::score::LegScores;
use crate::prelude::*;
...
/// [`crate::domains::retrieval::pipeline::pool_size`]) — this stage produces a
