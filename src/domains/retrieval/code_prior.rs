...
//!
//! Two consumers share this math: [`crate::domains::retrieval::code_rerank`]
//! multiplies the prior product into a max-normalized relevance score for
//! `comemory search-code`, and [`crate::domains::retrieval::bundle`] ranks the code
...
/// info. Unlike [`crate::domains::retrieval::code_rerank::CodeScoreParts`] there is
