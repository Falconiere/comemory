...
use crate::domains::retrieval::graph_route::{self, GraphFuse};
...
/// [`crate::domains::retrieval::pipeline::pool_size`], which clamps it into
...
/// floor in [`crate::domains::retrieval::code_route`]
