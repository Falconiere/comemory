...
//!
//! Consumes the [`RoutedHit`] list produced by [`crate::domains::retrieval::router`]
//! and emits [`Reranked`] entries (carrying body + simhash) for the
//! diversify stage. All priors come from [`crate::domains::retrieval::score`]; the
//! clamp and decay knobs come from `cfg.rank`.

use time::OffsetDateTime;

use crate::config::Config;
use crate::domains::retrieval::router::{RoutedHit, Source};
