...
//!
//! Split out of [`crate::domains::learning::evaluation::tune`] (Binding Rule 3): `tune.rs` owns the
...
/// Pool sizes in [`crate::domains::learning::evaluation::tune::grid`] nesting order: `graph_hops`,
...
/// version. Same construction as [`crate::domains::learning::evaluation::bandit::sample_seed`],
...
/// any pool shape; the single caller in [`crate::domains::learning::evaluation::tune`] passes the
