...
//! lives in [`crate::domains::learning::evaluation::tune_sample`]).
...
use crate::domains::learning::evaluation::golden::GoldenPair;
use crate::domains::learning::evaluation::runner::{self, EvalReport};
use crate::domains::learning::evaluation::tune_sample;
use crate::prelude::*;
...
pub(crate) fn validated_with_candidate(base: &Config, c: &TuneCandidate) -> Result<Config> {
    with_candidate(base, c)
        .validate()
