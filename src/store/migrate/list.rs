...
pub const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        ...
        class: Class::Additive,
        post: None,
        markers: &["0016_v16_sync"],
    },
    Migration {
        key: "0017_sync_repush",
        sql: M_V17,
        class: Class::Destructive,
        post: None,
        markers: &["0017_sync_repush"],
    },
    Migration {
        key: "0018_scheme_path_refs",
        sql: M_V18,
        class: Class::Destructive,
        post: None,
        markers: &["0018_scheme_path_refs"],
    },
    Migration {
        key: "0019_query_performance",
        sql: M_V19,
        class: Class::Additive,
        post: None,
        markers: &["0019_query_performance"],
    },
    Migration {
        key: "0020_candidate_observations",
        sql: M_V20,
        class: Class::Additive,
        post: None,
        markers: &["0020_candidate_observations"],
    },
    Migration {
        key: "0021_activity_log",
        sql: M_V21,
        class: Class::Additive,
        post: None,
    ...
    Migration {
        key: "0023_memory_write_intent",
        sql: M_V23,
        class: Class::Additive,
        post: None,
        markers: &["0023_memory_write_intent"],
    },
    Migration {
        key: "0024_code_generation",
        sql: M_V24,
        class: Class::Additive,
        post: None,
        markers: &["0024_code_generation"],
    },
    Migration {
        key: "0025_document_revision",
        sql: M_V25,
        class: Class::Additive,
        post: None,
        markers: &["0025_document_revision"],
    },
    Migration {
        key: "0026_replica_events",
        sql: M_V26,
        class: Class::Additive,
        post: None,
    ...
    Migration {
        key: "0028_historical_document_revision",
        sql: M_V28,
        class: Class::Destructive,
        post: Some(historical_document_revision::repair),
        markers: &[
