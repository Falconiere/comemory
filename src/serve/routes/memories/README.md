...
| `search.rs` | `router` | `GET\|POST /memories/search` (`domains::retrieval::search`) and `GET\|POST /context` (`domains::retrieval::context`), including access-tracking suppression |
