...
/// [`feedback::Request`]'s four id lists by [`into_feedback`].
#[derive(Deserialize, Debug)]
#[serde(deny_unknown_fields)]
struct HitFeedback {
    ...
    /// to [`feedback::Request::source`] verbatim; the core validates
...
fn into_feedback(query_id: String, req: HitFeedback) -> Result<feedback::Request> {
